  ...
  return (
    <div className="accounting-page">
      ...
      <section className="accounting-hero">
        ...
        <div className="accounting-hero-overlay"></div>

        <div className="accounting-hero-content">  
          <h1>Modern Accounting Software Solutions</h1>
          <p>
            Streamline financial management with automation, security, and
            powerful insights designed for businesses of all sizes.
          </p>
